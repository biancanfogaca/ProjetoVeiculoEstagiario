public abstract class BaseVeiculosTerrestres extends BaseVeiculos{
    ...
    public BaseVeiculosTerrestres(int codigo, String chassi, String nome, String modelo, int anoModelo,
