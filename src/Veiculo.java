public abstract class Veiculo extends BaseDadosComuns implements Impressao {
    ...
    public Veiculo(int codigo, String chassi, String nome, String modelo, int anoModelo, int anoFabricacao,
